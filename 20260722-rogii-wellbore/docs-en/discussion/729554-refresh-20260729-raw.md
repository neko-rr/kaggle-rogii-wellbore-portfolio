...
笏・ Most of that type error is shape or memory error related to the fact...
  ...
  笏・ I reproduced the problem by running the pipeline with more wells. The failure was caused by offset_inicio being gene...
    ...
    笏懌楳 Angel R, Gadea L. (2026-07-28 19:02:12.017000) [+0]
    笏・ I followed your suggestion and removed the dependency on sample_submission. I also verified the pipeline with 200 simulated wells and the final submission format. However, the private evaluation st...
    笏懌楳 PC Jimmmy (2026-07-29 03:23:41.243000) [+0]
    笏・ Yes - too close to the end to make them public.   I would use one of the LLM's and see what they might have to offer.
