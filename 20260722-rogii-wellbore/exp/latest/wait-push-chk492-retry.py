#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Indent修正済み tip-cv-chk492 を GPU 空きで再 push（496/492b はキャンセルしない）."""
...
LOG = COMP / "exp/latest/wait-push-chk492-retry.log"
HOLD = [
